...
struct GameOptionsWindow : Window {
	...
	DropDownList BuildDropDownList(int widget, int *selected_index) const
	{
		...
		switch (widget) {
			...
			case WID_GO_GUI_ZOOM_DROPDOWN: {
				*selected_index = _gui_zoom_cfg == ZOOM_LVL_GUI_AUTO ? 0 : ZOOM_LVL_OUT_4X - _gui_zoom + 1;
			...
			case WID_GO_FONT_ZOOM_DROPDOWN: {
				*selected_index = _font_zoom_cfg == ZOOM_LVL_GUI_AUTO ? 0 : ZOOM_LVL_OUT_4X - _font_zoom + 1;
	...
	void SetStringParameters(int widget) const override
	{
		switch (widget) {
			...
			case WID_GO_GUI_ZOOM_DROPDOWN:   SetDParam(0, _gui_zoom_dropdown[_gui_zoom_cfg != ZOOM_LVL_GUI_AUTO ? ZOOM_LVL_OUT_4X - _gui_zoom_cfg + 1 : 0]); break;
			case WID_GO_FONT_ZOOM_DROPDOWN:  SetDParam(0, _font_zoom_dropdown[_font_zoom_cfg != ZOOM_LVL_GUI_AUTO ? ZOOM_LVL_OUT_4X - _font_zoom_cfg + 1 : 0]); break;
	...
	void OnDropdownSelect(int widget, int index) override
	{
		switch (widget) {
			...
			case WID_GO_GUI_ZOOM_DROPDOWN:
				GfxClearSpriteCache();
				_gui_zoom_cfg = index > 0 ? ZOOM_LVL_OUT_4X - index + 1 : ZOOM_LVL_GUI_AUTO;
				UpdateGUIZoom();
				UpdateCursorSize();
				UpdateAllVirtCoords();
				FixTitleGameZoom();
			...
			case WID_GO_FONT_ZOOM_DROPDOWN:
				GfxClearSpriteCache();
				_font_zoom_cfg = index > 0 ? ZOOM_LVL_OUT_4X - index + 1 : ZOOM_LVL_GUI_AUTO;
				UpdateGUIZoom();
				ClearFontCache();
