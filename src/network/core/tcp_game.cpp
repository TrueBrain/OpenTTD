...
NetworkRecvStatus NetworkGameSocketHandler::HandlePacket(Packet *p)
{
	...
	switch (this->HasClientQuit() ? PACKET_END : type) {
		...
		case PACKET_CLIENT_SERVER_INFO:           return this->Receive_CLIENT_SERVER_INFO(p);
		case PACKET_SERVER_SERVER_INFO:           return this->Receive_SERVER_SERVER_INFO(p);
...
NetworkRecvStatus NetworkGameSocketHandler::Receive_CLIENT_SERVER_INFO(Packet *p) { return this->ReceiveInvalidPacket(PACKET_CLIENT_SERVER_INFO); }
NetworkRecvStatus NetworkGameSocketHandler::Receive_SERVER_SERVER_INFO(Packet *p) { return this->ReceiveInvalidPacket(PACKET_SERVER_SERVER_INFO); }
