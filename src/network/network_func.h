...
void NetworkClientConnectGame(ServerAddress address, CompanyID join_as, const char *join_server_password = nullptr, const char *join_company_password = nullptr);
