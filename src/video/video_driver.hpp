...
public:
	VideoDriver() : is_game_threaded(true), request_game_state_mutex(false) {}
...
protected:
	...
	std::condition_variable_any game_state_locked_signal;
	std::atomic<bool> request_game_state_mutex;
