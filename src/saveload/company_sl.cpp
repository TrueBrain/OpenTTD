...
public:
	...
	void Load(CompanyProperties *c) const override
	{
		size_t num_liveries = IsSavegameVersionBefore(SLV_63) ? LS_END - 4 : IsSavegameVersionBefore(SLV_85) ? LS_END - 2: IsSavegameVersionBefore(SLV_SAVELOAD_LIST_LENGTH) ? (int)LS_END : SlGetStructListLength(LS_END);
