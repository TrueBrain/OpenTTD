...
static const SaveLoad _old_station_desc[] = {
	...
	SLE_CONDREFLST(Station, loading_vehicles,        REF_VEHICLE,                SLV_57, SL_MAX_VERSION),
...
SaveLoadTable GetGoodsDesc()
{
	static const SaveLoad goods_desc[] = {
		...
		SLEG_CONDREFLST(         _packets,             REF_CARGO_PACKET,           SLV_68, SLV_183),
...
static const SaveLoad _cargo_list_desc[] = {
	...
	SLE_REFLST(StationCargoPair, second, REF_CARGO_PACKET),
};
	...
	SLE_ST_INCLUDE(),
	 ...
	 SLEG_CONDARR(_old_st_persistent_storage.storage,  SLE_UINT32, 16,            SLV_145, SLV_161),
	  SLE_CONDREF(Station, airport.psa,                REF_STORAGE,               SLV_161, SL_MAX_VERSION),
	      ...
	      SLE_REFLST(Station, loading_vehicles,        REF_VEHICLE),
