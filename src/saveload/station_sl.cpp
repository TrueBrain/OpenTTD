...
public:
	...
	void Load(BaseStation *bst) const override
	{
		...
		size_t num_cargo = IsSavegameVersionBefore(SLV_55) ? 12 : IsSavegameVersionBefore(SLV_EXTEND_CARGOTYPES) ? 32 : IsSavegameVersionBefore(SLV_SAVELOAD_LIST_LENGTH) ? (size_t)NUM_CARGO : SlGetStructListLength(NUM_CARGO);
		for (CargoID i = 0; i < num_cargo; i++) {
...
class SlStationCommon : public DefaultSaveLoadHandler<SlStationCommon, BaseStation> {
public:
	inline static const SaveLoad description[] = {
	...
	inline const static SaveLoadCompatTable compat_description = _station_common_sl_compat;
...
static const SaveLoad _station_desc[] = {
	...
	SLEG_STRUCT("common", SlStationCommon),
...
static const ChunkHandler station_chunk_handlers[] = {
	{ 'STNS', nullptr,       Load_STNS,     Ptrs_STNS,     nullptr, CH_TABLE },
