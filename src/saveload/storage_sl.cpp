...
static const ChunkHandler __persistent_storage_chunk_handlers[] = {
	{ 'PSAC', Save_PSAC, Load_PSAC, nullptr, nullptr, CH_ARRAY },
};

extern const ChunkHandlerTable _persistent_storage_chunk_handlers(__persistent_storage_chunk_handlers);
